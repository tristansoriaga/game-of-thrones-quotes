...
export const RandomQuotes = () => {
  ...
  return (
    <Stack as='section' justifyContent='center' borderRadius='3xl' border='10px solid black' p='1rem' m='4rem'>
      ...
      <Box>
        <Image w='320px' src={getImages(quotes?.character?.slug)} />
      </Box>
      ...
      <Box bg='gray.200' borderRadius='lg' py='1.5rem' px='5px' border='3px solid black'>
